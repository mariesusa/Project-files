...
user_prompt = "What would you like to know about Python?"

import requests
import json

user_input = "Does Python run on all big operating systems?"
relevant_document = return_response(user_input, corpus_of_documents)
full_response = []
# https://github.com/jmorganca/ollama/blob/main/docs/api.md
prompt = """
You are a bot that answers questions relating to the programming language Python. You answer in very short sentences and do not include extra information.
